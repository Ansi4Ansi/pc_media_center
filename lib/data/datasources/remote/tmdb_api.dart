...
class TMDbApiClient {
  ...
  Future<Map<String, dynamic>> searchMovies(String query) async {
    try {
      ...
      throw _mapDioException(e, 'TMDB searchMovies', stackTrace);
    } catch (e, stackTrace) {
      throw ApiException(
        'Failed to search movies in TMDB: $e',
  ...
  Future<Map<String, dynamic>> getMovieDetails(int movieId) async {
    try {
      ...
      throw _mapDioException(e, 'TMDB getMovieDetails', stackTrace);
    } catch (e, stackTrace) {
      throw ApiException(
        'Failed to get movie details from TMDB: $e',
        stackTrace: stackTrace,
      );
    }
  }
  ...
  Future<Map<String, dynamic>> getMovieImages(int movieId) async {
    try {
      ...
      throw _mapDioException(e, 'TMDB getMovieImages', stackTrace);
    } catch (e, stackTrace) {
      throw ApiException(
        'Failed to get movie images from TMDB: $e',
        stackTrace: stackTrace,
      );
    }
  }
